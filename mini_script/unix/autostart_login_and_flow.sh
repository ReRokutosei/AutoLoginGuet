...
SCRIPT_NAME="login_and_flow.sh"
SERVICE_NAME="autologin-guet-login-flow.service"
PLIST_NAME="com.autologin.guet.login.flow.plist"

echo "设置 login_and_flow 脚本自启动..."
...
<dict>
    <key>Label</key>
    <string>com.autologin.guet.login.flow</string>
...
[Unit]
Description=Auto Login GUET with Flow Query
